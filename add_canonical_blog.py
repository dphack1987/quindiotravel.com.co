...
"""
Agregar canonical URLs a páginas de blog
...
def add_canonical_to_page(file_path):
    ...
    try:
        ...
        canonical_url = f"https://quindiotravel.com.co/blog/{file_name}"
...
def main():
    print("Agregando canonical URLs a paginas de blog")
    print("="*60)
    ...
    if not blog_dir.exists():
        print("ERROR: Directorio blog no encontrado")
        return
