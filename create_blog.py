...
articles = [
    {
        "file": "mejor-epoca-visitar-quindio-2026.html",
...
<head>
    ...
    <meta name="description" content="Guía completa sobre la mejor época para visitar Quindío en 2026.">
    <meta name="keywords" content="mejor época visitar quindío, cuando ir quindío, clima quindío">
...
<body>
    ...
    <nav class="breadcrumb-nav" aria-label="Breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li>Mejor época para visitar Quindío en 2026</li>
            </ol>
        </div>
    </nav>
    ...
    <main class="blog-post container">
        <article class="article-content">
            <h1>Mejor época para visitar Quindío en 2026 - Guía Completa</h1>
            
            <div class="article-meta">
                <p class="article-date">Publicado: 3 de agosto de 2026</p>
    ...
    {
        "file": "hoteles-economicos-salento-familias-2026.html",
        "title": "Hoteles económicos en Salento para familias grandes - Guía 2026",
        "content": """<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <title>Hoteles económicos en Salento para familias grandes 2026 | Quindío Travel</title>
    <meta name="description" content="Guía de hoteles económicos en Salento para familias grandes en 2026.">
    <meta name="keywords" content="hoteles economicos salento, alojamiento salento familias, hoteles baratos salento">
    <link rel="stylesheet" href="../styles.css">
</head>
<body>
    <header class="main-header">
    ...
    <nav class="breadcrumb-nav" aria-label="Breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="../index.html">Inicio</a></li>
                <li><a href="../blog.html">Blog</a></li>
                <li>Hoteles económicos en Salento para familias grandes</li>
            </ol>
        </div>
    </nav>
    ...
    <main class="blog-post container">
        <article class="article-content">
            <h1>Hoteles económicos en Salento para familias grandes - Guía 2026</h1>
            ...
            <div class="article-cta">
                <h2>¿Listo para reservar tu alojamiento en Salento?</h2>
                <p>Cotiza gratis tu plan familiar con operadores locales certificados RNT 18152.</p>
                <a href="https://wa.me/573174426044?text=Hola%20Quindío%20Travel,%20estoy%20interesado%20en%20alojamiento%20en%20Salento" class="btn-cta">
                    Cotizar Alojamiento Familiar
                </a>
            </div>
        </article>
    </main>
...
for article in articles:
    try:
        filepath = blog_dir / article["file"]
        with open(filepath, 'w', encoding='utf-8') as f:
            f.write(article["content"])
        
        generated_count += 1
        print(f"✅ Artículo generado: {article['file']}")
