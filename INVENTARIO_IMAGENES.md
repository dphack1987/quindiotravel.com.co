...
| **.mp4** | 19 | `assets/images/fotos-para-para-quindio-travel/` | Videos promocionales |
...
- `assets/images/alojamientos/finca-hotel-los-girisoles-placeholder.svg`
- `assets/images/alojamientos/hotel-campestre-cafe-cafe-placeholder.svg`
...
## 🎬 Videos Promocionales (19 archivos .mp4)

### **Cascadas Río Verde (13 videos)**
- `assets/images/fotos-para-para-quindio-travel/Fotos/CASCADAS RIO VERDE/WhatsApp Video 2024-07-10 at 9.03.57 AM.mp4`
- `assets/images/fotos-para-para-quindio-travel/Fotos/CASCADAS RIO VERDE/WhatsApp Video 2024-07-10 at 9.04.12 AM.mp4`
- ... (13 videos de WhatsApp)

### **RECUCA (1 video)**
- `assets/images/fotos-para-para-quindio-travel/Fotos/Fotos RECUCA/173084347_482668522923486_3450326418871996414_n.mp4`

### **Videos generales (5 videos)**
- `assets/images/fotos-para-para-quindio-travel/Video 2.mp4`
- `assets/images/fotos-para-para-quindio-travel/WhatsApp Video 2024-06-04 at 4.13.27 PM.mp4`
- `assets/images/fotos-para-para-quindio-travel/WhatsApp Video 2024-06-11 at 7.05.33 PM.mp4`
- ... (más videos)

---

## 🎨 Imágenes UI y Branding (4 archivos)

### **Logos y Avatares**
- `assets/images/don-chucho-avatar.svg` - Avatar Don Chucho (chatbot)
- `assets/images/hero/valle-del-cocora-placeholder.svg` - Placeholder hero
- `assets/images/planes/plan-3d-placeholder.svg` - Placeholder plan 3 días
- `assets/images/planes/plan-4d-placeholder.svg` - Placeholder plan 4 días
- `assets/images/planes/plan-5d-placeholder.svg` - Placeholder plan 5 días

---

## 📈 Clasificación por Uso Recomendado
...
- ✅ Filandia: 1 imagen disponible
- ✅ Armenia: 1 imagen disponible
- ❌ Valle de Cocora: Sin imágenes específicas

### **Para Redes Sociales**
- ✅ Mariposario: 6 imágenes
- ✅ Termales: 4 imágenes
- ✅ RECUCA: 6 imágenes
- ✅ Videos: 19 archivos para contenido

### **Para Website UI**
- ✅ Placeholders para planes (3 archivos)
- ✅ Logo Don Chucho (1 archivo)
- ✅ Placeholder hero (1 archivo)
...
- Imágenes mezcladas en directorios sin estructura clara
- Sin nombres descriptivos
- Sin carpetas específicas por plan

### **4. Falta de Imágenes por Plan**
- No hay imágenes específicas para cada plan
- Solo placeholders SVG genéricos
- Falta galería de imágenes hero por plan

### **5. Videos No Organizados**
- 19 videos en directorio temporal `fotos-para-para-quindio-travel`
- Sin descripción de contenido
- Sin organización por atractivo
...
6. **Organizar videos** - Mover a estructura lógica

### **3. Imágenes Hero Recomendadas por Plan**
- **Plan 1:** Parque del Café + PANACA (usar imágenes de atractivos)
- **Plan 2:** Salento + Parque del Café (usar paisajes Salento)
- **Plan 3:** Valle de Cocora + Salento (necesitan imágenes específicas)
- **Plan 4:** Termales Santa Rosa (usar imágenes de termales)
- **Plan 5:** RECUCA + Cultura cafetera (usar imágenes RECUCA)
- **Plan 6:** Hotel Las Camellias + Destinos VIP (usar alojamientos VIP)
